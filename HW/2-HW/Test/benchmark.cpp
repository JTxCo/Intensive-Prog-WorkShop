...
// Broke up the function to just use integers
...
std::vector<double> readDecimals(const std::string& filepath) {
    std::ifstream file(filepath);
...
std::vector<std::string> readStrings(const std::string& filepath) {
    std::ifstream file(filepath);
